...
public class IndexActivity extends FragmentActivity implements ActionBar.TabListener{
    ...
    private void setUpActionBar() {
    	...
    	try {  
            Method setHasEmbeddedTabsMethod = actionBar.getClass().getDeclaredMethod(  
    	...
    	Drawable myDrawable = r.getDrawable(R.drawable.logo2);
//    	actionBar.setBackgroundDrawable(myDra/wable);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
    	Log.d("--------start-----", "onMenuItemSelected");
    	 switch (item.getItemId()) {  
    	    case android.R.id.home:  
    	    	Log.d("--------------", "onMenuItemSelected");
//    	        Toast.makeText(this, "onMenuItemSelected", Toast.LENGTH_SHORT).show();  
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		Log.d("--------start-----", "onOptionsItemSelected");
		 switch (item.getItemId()) {  
		    case android.R.id.home:  
